...
public class BorsusEntity extends TameableEntity implements IAngerable, IAnimatedEntity, IRideable, IJumpingMount {
    ...
    private static final DataParameter<Boolean> IS_ATTACKING = EntityDataManager.createKey(BorsusEntity.class, DataSerializers.BOOLEAN);
    ...
    public void onStruckByLightning(LightningBoltEntity lightningBolt) {
        ...
        DrakelEntity drakelentity = ModEntityTypes.DRAKEL.get().create(this.world);
    }
    ...
    public static boolean func_223320_c(EntityType<BorsusEntity> p_223320_0_, IWorld p_223320_1_, SpawnReason reason, BlockPos p_223320_3_, Random p_223320_4_) {
    ...
    private <E extends BorsusEntity> boolean moveController(AnimationTestEvent<E> event) {
        if(event.isWalking()) {
            moveController.setAnimation(new AnimationBuilder().addAnimation("animation.testermodding.borsusWalk",true).addAnimation("animation.testermodding.borsusIdle", true));
        return true;
        }
        if(isAttacking()) {
            moveController.setAnimation(new AnimationBuilder().addAnimation("animation.testermodding.borsusAttack",true).addAnimation("animation.testermodding.borsusAttack", true));
            return true;
        }
        else {
    ...
    public void registerAnimationControllers()
    {
        if(world.isRemote)
        {
            ...
            moveController.registerSoundListener(this::breathListener);
        }
    }
    ...
    private <ENTITY extends Entity> SoundEvent breathListener(SoundKeyframeEvent<ENTITY> event) {
        if (event.sound.equals("ambient")) {
    ...
    class MeleeAttackGoal extends net.minecraft.entity.ai.goal.MeleeAttackGoal {
        ...
        protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
            ...
            if (distToEnemySqr <= d0 && this.func_234040_h_()) {
                ...
                BorsusEntity.this.setAttacking(true);
            } else if (distToEnemySqr <= d0 * 2.0D) {
                if (this.func_234040_h_()) {
                    BorsusEntity.this.setStanding(false);
                    BorsusEntity.this.setAttacking(false);
                    this.func_234039_g_();
                }
